...
def code_churn():
    ...
    try:
        ...
        return jsonify({"error": "num_commits_before_latest must be an integer"}), 400
    ...
    try:
        if method == "modified":
            ...
            try:
                ...
                return jsonify({"error": "Failed to clone repository. It may be private or invalid."}), 400
            ...
            return jsonify(get_git_code_churn(repo_url, num_commits_before_latest))
        else:
